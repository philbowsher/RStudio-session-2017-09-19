...
leaflet() %>% addTiles() %>% setView(-122.281633, 37.566961, zoom = 12) %>% 

addMarkers(data = starbucks_CA, lat = ~ Latitude, lng = ~ Longitude, popup = starbucks_CA$Name)
